...
const required = [
  ...
  "src/assurance/external-evidence.ts", "src/assurance/operator.ts",
  "src/platform/types.ts", "src/platform/repository.ts", "src/platform/service.ts", "src/platform/routes.ts",
  ...
  "migrations/003_identity_slice2.sql", "migrations/004_identity_phase_b.sql", "migrations/005_platform_foundation.sql",
  ...
  "scripts/external-assurance-evidence.ts", "scripts/assurance-operator.ts", "scripts/staging-preflight.ts", "scripts/staging-smoke.ts", "scripts/security-check.mjs",
  ...
  "docs/EXTERNAL_ASSURANCE_PROVENANCE_RECONCILIATION.md", "docs/ASSURANCE_OPERATOR.md", "docs/PLATFORM_FOUNDATION.md", "docs/STAGING_ASSURANCE_FOUNDATION.md", "docs/STAGING_DEPLOYMENT_RUNBOOK.md", "docs/STAGING_FOUNDATION_CI_RECONCILIATION.md",
  ...
  ".github/workflows/external-assurance-controls.yml", ".github/workflows/assurance-operator.yml", ".github/workflows/platform-foundation.yml", ".github/workflows/release-image.yml", ".github/workflows/staging-foundation.yml", ".github/dependabot.yml"
];
...
if (!readme.includes("4.0.0") || !readme.includes("Multi-Tenant Platform Foundation Release 1")) fail("README authority is stale");
...
if (!sourceVersion.includes('PHOENIX_VERSION = "4.0.0"')) fail("source version authority is stale");
