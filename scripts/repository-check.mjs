...
const required = [
  ...
  "docs/EXTERNAL_ASSURANCE_PROVENANCE_RECONCILIATION.md", "docs/ASSURANCE_OPERATOR.md", "docs/STAGING_ASSURANCE_FOUNDATION.md", "docs/STAGING_DEPLOYMENT_RUNBOOK.md", "docs/STAGING_FOUNDATION_CI_RECONCILIATION.md",
  ...
  ".github/workflows/external-assurance-controls.yml", ".github/workflows/assurance-operator.yml", ".github/workflows/release-image.yml", ".github/workflows/staging-foundation.yml", ".github/dependabot.yml"
];
...
if (!readme.includes("3.9.0") || !readme.includes("Assurance Automation and Operator Release 1")) fail("README authority is stale");
...
if (!sourceVersion.includes('PHOENIX_VERSION = "3.9.0"')) fail("source version authority is stale");
